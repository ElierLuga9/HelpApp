...
public class ExamplePrioridadUno extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.layout_prioridaduno, null);
        ...
        Nor = view.findViewById(R.id.textView10);
