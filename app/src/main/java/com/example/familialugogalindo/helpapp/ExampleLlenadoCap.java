...
public class ExampleLlenadoCap extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.layout_perfusion, null);
        ...
        Nor = view.findViewById(R.id.textView11);
        pul = view.findViewById(R.id.imageView4);
